/*========================================================================
  ...
  ------------------------------------------------------------------------
    Copyright (C) 1999-2002  James R. Bruce, Anna Helena Reali Costa
  ...
  ------------------------------------------------------------------------
    Revision History:
      2001-11-10:  Back to single field due to driver instability (jbruce)
      2001-03-15:  Some tweaks for separate field capture (jbruce)
      2000-02-05:  Ported to work with V4L2 API (jbruce)
